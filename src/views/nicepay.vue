<template>
  <div>
    ...
    <a-button class="font-weight-bold mt-3 mr-3" type="primary" @click="pay()"
      >Pay</a-button
    >
    <a-button class="font-weight-bold mt-3 mr-3" type="primary" @click="check()"
      >Check</a-button
    >
  </div>
</template>
  ...
  methods: {
    pay() {
      ...
      const params =
        ...
        "&iMid=IONPAYTEST&payMethod=01&currency=IDR&amt=500000&referenceNo=TRX2020090700000002&goodsNm=Deposit&billingNm=Michael&billingPhone=081212121212&billingEmail=michael@blah.com&billingCity=Jakarta&billingState=JakSel&billingPostCd=16413&billingCountry=Indonesia&dbProcessUrl=dbproc&merchantToken=" +
        token.toString() +
